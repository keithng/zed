...
// 				"stroke-opacity":0,
		...
		sideSwarm:{
			...
			text:{},
			bar:{
				rounded:null, // Force rounded so complex rectangles are drawn
				parallelSize:1,
				"stroke-width":0.5
			}
		},
	...
	var background = new zRectangle({L:L.base, base:Y.background}),
			...
			bar:{
				...
				curr:function (S, D, mode) {
					...
					return {
						...
						opacity:(D.A[2] == tAxis.selected.a) ? 1 : 0.5
					};
				}
			}
		}
