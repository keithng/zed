HotTree = function (rawData, style, layout) {
	...
	tooltipBox.stopMouseEvents(); // Disable tooltipbox's remove on mouseover
	...
	var swarm = new zSwarm({
		...
		setURL:function () {
			document.location.hash = this.selected.a;
		},
		getVal:function (A) {
		...
		zoomTo:function (aPos, force) {
			...
			var S = this, t = Y.highlight.t, e = Y.highlight.e, layout,
				iterate = function () {S.zoomTo(aPos, true)}, // This carries the original aPos all the way through
