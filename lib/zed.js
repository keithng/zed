...
// 						};
	...
	c.autoImport = function (rawData) {
		if (rawData.meta && rawData.data) c.importProtoCube(rawData);
		else if (rawData[0] instanceof Array && typeof rawData[0][0] == "string") c.importStrip(rawData);
	};
	...
	c.type = "zDataCube";
	c.initialise(d);
	if (rawData) c.autoImport(rawData);
};
