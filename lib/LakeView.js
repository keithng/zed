	...
	var swarm = new zSwarm({ // Resources
		...
		treemap:function (aPos, t, e, b, w) {
			var S = this,
				...
				currTime = dc.asAPos({d:1, r:S.R[1]}),
		...
		plan:{
			title:{
				...
				init:function (S, A, D) {
					return {
						text:"Budget " + dc.getMeta("name", {d:1, r:S.R[1] - 1}),
